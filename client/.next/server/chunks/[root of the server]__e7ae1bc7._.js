...
"[project]/.next-internal/server/app/api/visits/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/visits/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    ...
    const { data: userData, error: userError } = await supabase.from('users').select('id').eq('email', session.user.email).single();
    ...
    `).eq('user_id', userData.id).order('appointment_time', {
        ascending: true
    });
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__e7ae1bc7._.js.map