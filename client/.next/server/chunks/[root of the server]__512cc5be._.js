...
async function PUT(request) {
    try {
        ...
        const { data, error } = await supabase.from('users').update(body).eq('email', session.user.email).select().single();
        if (error) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__512cc5be._.js.map